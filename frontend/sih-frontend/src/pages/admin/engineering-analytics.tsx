...
export function EngineeringAnalytics() {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden container mx-auto px-4 py-8">
...
<header className="bg-white shadow-sm">
      ...
      <br></br>
      <h1 className="text-3xl font-bold mb-8 text-center">Engineering Department Analytics</h1>
